...
class PasswordRecoveryForm(forms.Form):
    ...
    error_messages = {
        'not_found': _("Questo utente non esiste."),
    }
    ...
    def __init__(self, *args, **kwargs):
        ...
        message = ("Di default non sono supportati altri campi oltre mail e username")
    ...
    def clean_username_or_email(self):
        ...
        if recovery_only_active_users and not user_is_active:
            raise forms.ValidationError(_("Gli utenti non attivi non possono "
    ...
    def get_user_by_both(self, username):
        ...
        try:
            ...
            raise forms.ValidationError(_("Impossibile trovare utente"))
