...
class AssembleaModelAdmin(admin.ModelAdmin):
	list_display = ["data_assemblea", "mostra_assemblea", "nascondi_assemblea", "numero_turni", "edit_turni"]
	list_display_links = ["data_assemblea"]
	list_filter = ["data_assemblea", "mostra_assemblea"]
	search_fields = ["data_assemblea"]
...
class TurnoModelAdmin(admin.ModelAdmin):
	list_display = ["ora", "orario_fine", "numero_gruppi", "desc_assemblea", "edit_gruppi"]
	list_filter = ["ora"]
	list_search = ["ora"]
